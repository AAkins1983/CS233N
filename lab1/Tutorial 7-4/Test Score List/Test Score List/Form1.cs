...
namespace Test_Score_List
{
    public partial class Form1 : Form
    {
        ...
        private void DisplayScores(/* TODO:  add the parameter here */List<int> scoresList)
        {
        ...
        private double Average(/* TODO:  add the parameter here */List<int> scoresList)
        {
        ...
        private int AboveAverage(/* TODO:  add the parameter here */List<int> scoresList)
        {
        ...
        private int BelowAverage(/* TODO:  add the parameter here */List<int> scoresList)
        {
