...
namespace String_Stuff
{
    public partial class stringForm : Form
    {
        ...
        // EXTRA CREDIT: cool user interface, let user pick code (text boxes)
        ...
        private string SubCypher(string input, string charsToSub)       //input = what's the string you want to encode, charsToSub = what's the code you want to use.
        {
            string output = "";
            string alpha = "abcdefghijklmnopqrstuvwxyz";
        ...
        private void transformButton_Click(object sender, EventArgs e)
        {
            ...
            subTextBox.Text = SubCypher(input, input);
